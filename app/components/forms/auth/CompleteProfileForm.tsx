  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "petitionerName",
          label: "U.S. Petitioner's Name (if any)",
          type: "text",
        },
        { name: "caseNumber", label: "Case Number (if any)", type: "text" },
        {
          name: "travelHistory",
          label: "Prior U.S. Travel History",
          type: "textarea",
        },
        {
          name: "educationLevel",
        ...
        { name: "startDate", label: "Employment Start Date", type: "date" },
        {
          ...
          label: "Previous Employers (last 5-10 years)",
          type: "textarea",
        },
        {
          name: "employmentGaps",
          label: "Employment Gaps (if any)",
          type: "textarea",
        },
        { name: "annualIncome", label: "Annual Income", type: "text" },
        {
          name: "sponsorDetails",
          label: "Sponsor Details (if applicable)",
          type: "textarea",
        },
        {
          name: "bankStatement",
          label: "Bank Statement/Assets Summary",
          type: "textarea",
        },
        {
          name: "residenceHistory",
          label: "All Addresses (past 5-10 years)",
          type: "textarea",
        },
        {
          name: "countriesVisited",
          label: "Countries Visited (last 5 years)",
          type: "textarea",
        },
        {
          name: "longTermStays",
          label: "Long-term Stays Abroad",
          type: "textarea",
        },
      ],
    },
  ...
  return (
    <Card className="p-8 bg-card shadow-lg border-border">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {error && (
          <div className="p-3 bg-red-50/10 border border-red-200/20 rounded-lg text-red-600 text-sm">
            {error}
          </div>
        )}
