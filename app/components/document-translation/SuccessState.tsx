...
export default function SuccessState({ onGoToRequests }: SuccessStateProps) {
  return (
    <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 text-center">
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-2">Document Submitted Successfully!</h2>
      ...
      <p className="text-gray-700 mb-8">
        Our team will review your document and provide a ture English translation. 
        You can check the status of your request anytime in <span className="font-semibold">My Translation Requests.</span>
      </p>
