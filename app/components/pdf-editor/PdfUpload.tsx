        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-8">
              ...
              >
                <Upload className={`mx-auto h-16 w-16 mb-3 ${result ? 'text-primary/90' : 'text-gray-400'}`} />
                {result ? (
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {formatBytes(result.originalSize)} • {result.totalPages} page{result.totalPages !== 1 ? 's' : ''}
                    </p>
            ...
            {result && (
              <div className="mt-6 p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 rounded-lg shadow-sm">
                <div className="flex items-center text-green-700 mb-4">
                  ...
                  <span className="font-bold text-lg">PDF Loaded Successfully!</span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <p className="text-gray-500 text-xs font-medium mb-1">File Size</p>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-800 font-bold text-xl">{result.totalPages}</p>
                  </div>
                </div>
              </div>
            )}
