                        ...
                        <CardContent className="p-6 pt-4 mt-2">
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 col-span-3">
                              ...
                              <div className="mb-4">
                                <h5 className="font-medium text-gray-900 mb-2">Primary Applicant Documents</h5>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                  ...
                                  {!appointment.scanned_passport_url && !appointment.k_one_letter_url && !appointment.appointment_confirmation_letter_url && (
                                    <p className="text-gray-500 col-span-2">No documents uploaded</p>
                                  )}
                                </div>
                              </div>
                              ...
                              {appointment.applicants && appointment.applicants.length > 0 && (
                                <div className="mt-4">
                                  <h5 className="font-medium text-gray-900 mb-2">Additional Applicant Documents</h5>
                                  <div className="space-y-3">
                                    {appointment.applicants.map((applicant, index) => (
                                      <div key={applicant.id} className="border-l-4 border-purple-200 pl-4 py-2 bg-white">
                                        <h6 className="font-medium text-gray-800">Applicant #{index + 1}: {applicant.surname}, {applicant.givenName}</h6>
                          ...
                          <div className="mt-6 pt-4 border-t border-gray-200">
                            ...
                            <div className="flex space-x-3">
                              {(['pending', 'in_progress', 'completed', 'cancelled'] as AppointmentStatus[]).map((status) => (
                                <Button
                                  key={status}
