          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
            ...
            <div className="w-full md:w-auto flex flex-wrap items-center gap-3">
              <button
                ...
                className="flex-1 md:flex-none justify-center text-sm font-semibold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-3 py-2 rounded-full transition-colors flex items-center gap-2 border border-emerald-200"
              >
                <CheckCircle className="w-4 h-4" /> Check Best Visa
              </button>
              <button
                onClick={() => setIsHelpOpen(true)}
                className="flex-1 md:flex-none justify-center text-sm text-primary hover:text-primary/80 font-medium flex items-center gap-1 px-2 py-2"
              >
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden min-h-[300px] lg:min-h-[600px] flex flex-col">
            {highlightedJourney ? (
              <>
                ...
                {/* Footer Actions */}
                <div className="p-4 md:p-6 border-t border-slate-100 flex flex-col md:flex-row items-stretch md:items-center gap-3 bg-slate-50/50">
                  <Link
                    href="/visa-category/ir-category/ir1-journey"
                    className="w-full md:w-auto"
                  >
                    <Button className="w-full md:w-auto bg-teal-700 hover:bg-teal-800 text-white shadow-sm shadow-teal-900/10">
                      Start Journey
                    </Button>
                  </Link>
                  <Button
