      ...
      <div className="max-w-[1400px] mx-auto px-6 py-[60px]">
        <div className="max-w-5xl mx-auto mb-12">
          ...
          <p className="text-slate-500 mb-8 text-lg">
            Comprehensive roadmap for bringing your parents to the United States
          ...
          <div className="bg-[#e0f2fe] border-l-4 border-l-[#0d9488] p-4 rounded-xl mb-8 flex gap-3 items-start">
            <p className="text-base text-slate-800 leading-relaxed font-medium">
              <span className="font-bold">IR-5 Category:</span> This category is
              for parents of U.S. citizens who are at least 21 years old. The
              process follows similar stages to the spouse visa but has specific
              requirements for petitioner age and relationship proof.
            </p>
          </div>
          ...
          <div className="bg-secondary text-white rounded-xl p-10 mb-10">
            ...
            <ul className="space-y-2 mb-4">
              ...
              <li className="flex gap-2 text-sm">
                ...
                common mistakes to avoid, emotional support for separated family
                members
              </li>
            </ul>
