...
import { FormData } from '../types/221g';
...
export default function IntakeForm({ onSubmit }: IntakeFormProps) {
  ...
  const steps = [
    ...
    { id: 3, title: 'CEAC Status', description: 'Current status on CEAC system' },
    { id: 4, title: 'Additional Info', description: 'Any other relevant details' },
  ];
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Check the items that match your 221(g) letter
                    </p>
                  </div>
                </div>
              )}
