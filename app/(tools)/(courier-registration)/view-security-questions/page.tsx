      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-black tracking-tight text-gray-900">
            Security <span className="text-primary">Preview</span>
          </h1>
          <p className="text-gray-500 font-medium">
            Review your saved portal credentials and security responses.
          </p>
        </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-500 max-w-sm mx-auto">
                  You haven&apos;t saved any security questions yet.
                </p>
              </div>
              <Button
              ...
              >
                Go to Registration <ChevronRight size={18} />
              </Button>
            </CardContent>
          </Card>
        ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <CardTitle className="text-xl font-black text-gray-900 flex items-center gap-2">
                      <Lock className="text-primary" size={20} /> Credentials
                      Vault
                    </CardTitle>
              ...
              <CardContent className="p-8 space-y-10">
                ...
                <div className="relative group">
                  ...
                  <div className="relative space-y-3">
                    <Label className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] flex items-center gap-2 mb-1">
                      <User size={14} className="text-primary" /> Portal
                      Username
                    </Label>
                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 font-mono text-lg font-bold text-gray-800 break-all">
                      {data?.portal_username || "Not set"}
                    </div>
                  </div>
                </div>
                    ...
                    <div key={item.id} className="space-y-4">
                      ...
                      <div className="space-y-3 pl-9">
                        <p className="text-gray-900 font-bold text-lg leading-tight">
                          {item.q || "Question not selected"}
                        </p>
                        <div className="p-4 bg-primary/2 rounded-2xl border border-primary/5 font-mono text-base font-bold text-primary transition-all">
                          {showAnswers ? (
                            item.a || "---"
                          ) : (
            ...
            <div className="bg-blue-50/50 border border-blue-100 rounded-3xl p-6 flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-blue-700 font-medium leading-relaxed">
                  This page is for previewing your saved information. For your
                  security, always ensure you are in a private location before
                  revealing masked data.
                </p>
              </div>
            </div>
          </motion.div>
