          ...
          <Tabs defaultValue="documents" className="w-full">
            <div className="flex justify-center mb-10">
              <TabsList className="bg-white p-1 rounded-2xl shadow-md border border-gray-100 h-auto">
                <TabsTrigger
                  value="documents"
                  className="px-4 md:px-8 py-3 rounded-xl data-[state=active]:bg-primary data-[state=active]:text-white transition-all text-xs sm:text-sm font-bold gap-2"
                >
                  <FileText size={16} className="md:block hidden" /> Required
                  Documents
                </TabsTrigger>
                <TabsTrigger
                  value="questions"
                  className="px-4 md:px-8 py-3 rounded-xl data-[state=active]:bg-primary data-[state=active]:text-white transition-all text-xs sm:text-sm font-bold gap-2"
                >
                  <HelpCircle size={16} className="md:block hidden" /> Common
                  Questions
                </TabsTrigger>
                <TabsTrigger
                  value="inspection"
                  className="px-4 md:px-8 py-3 rounded-xl data-[state=active]:bg-primary data-[state=active]:text-white transition-all text-xs sm:text-sm font-bold gap-2"
                >
                  <AlertTriangle size={16} className="md:block hidden" />
            ...
            <TabsContent value="documents" className="space-y-8">
              ...
              >
                ...
                <motion.div variants={fadeInUp}>
                  <Card className="h-full border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden bg-white">
                ...
                <motion.div variants={fadeInUp}>
                  <Card className="h-full border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden bg-white">
                    <CardHeader className="bg-teal-50 border-b border-teal-100 pb-6">
                      <div className="flex items-center gap-3">
...
function DocumentItem({
  ...
  return (
    <div className="flex gap-4 p-4 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100 group">
      <div className="mt-1">
        <div className="p-2 bg-white rounded-lg shadow-sm group-hover:bg-primary/5 group-hover:text-primary transition-colors">
      ...
      <div className="space-y-1 flex-1">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {badge && (
            <Badge
              variant="secondary"
              className="bg-slate-100 text-[10px] uppercase tracking-wider font-bold text-slate-600"
            >
              {badge}
            </Badge>
          )}
...
function QuestionSection({
  ...
  return (
    ...
    >
      ...
      <AccordionContent className="bg-slate-50/50 px-6 py-4">
        <ul className="space-y-3">
          {questions.map((q, i) => (
            <li key={i} className="flex gap-3 text-sm text-slate-600">
              <span className="shrink-0 w-6 h-6 rounded-full bg-white border border-slate-200 flex items-center justify-center text-[10px] font-bold text-slate-400">
                {i + 1}
              </span>
