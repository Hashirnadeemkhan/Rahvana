        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full px-4 py-3 text-[0.9rem] border border-slate-200 rounded-[10px] bg-white text-slate-900 appearance-none cursor-pointer outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 transition-all font-medium font-['Plus_Jakarta_Sans',system-ui]"
            >
