...
const ValidationStep = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-6 rounded-xl border border-slate-200 bg-white mb-8">
        ...
        <div className="p-8 rounded-lg border-2 border-dashed border-slate-200 bg-slate-50 flex flex-col items-center gap-3 text-center">
          ...
          <motion.button
            ...
            `}
          >
            {uploadedFile ? "✓ Uploaded To Vault" : "Upload CRC to Vault"}
          </motion.button>
        </div>
      </div>
      ...
      {categories.map((category: any, ci: number) => (
        <div key={ci} className="mb-6">
          <div className="flex items-center gap-2 mb-3 font-['Plus_Jakarta_Sans',system-ui]">
