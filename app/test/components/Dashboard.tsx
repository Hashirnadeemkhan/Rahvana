            ...
            <div className="bg-secondary text-white rounded-xl p-10 mb-10">
              ...
              <ul className="space-y-2 mb-4">
                <li className="flex gap-2 text-sm">
                  ...
                  <strong>Goals:</strong> Quick platform tour, how to use
                  wizard, where to find tools
                </li>
                <li className="flex gap-2 text-sm">
                  <span className="text-amber-500">▸</span>{" "}
                ...
                <li className="flex gap-2 text-sm">
                  <span className="text-amber-500">▸</span>{" "}
                  <strong>Topics:</strong> Dashboard overview, starting your
                  first journey, marking steps complete, using document vault
                </li>
              </ul>
              ...
              <div>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm text-center">
                  ...
                  <p className="text-sm text-slate-500 mb-4">
                    You have{" "}
                    <strong>
                      {Object.keys(state.docUploads || {}).length}
                    </strong>{" "}
